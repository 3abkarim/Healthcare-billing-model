...
|---|---|---|
| Fact_Billing | Hospital billing revenue & volume | Country, BU, Month, Department, Payment Type |
| Fact_Marketing | Digital marketing revenue & volume | BU, Month |
| Fact_Medical_CRM | Medical CRM revenue & volume | BU, Month |
